...
const SeachWithFav = () => {
  return (
    <div className="flex items-center gap-4 w-[340px]">
      <div className="flex items-center border justify-around w-[290px] border-primary rounded-full px-4 py-2">
        <input
          type="text"
          className="flex-1 border-none focus:ring-0 focus:outline-none text-base"
          placeholder="Search..."
        />
